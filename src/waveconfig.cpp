...
uint16_t waveconfig::get_format(){
    return this->format;
}

uint16_t waveconfig::get_channel_amount(){
    return this->channels;
}

uint16_t waveconfig::get_sample_bitsize(){
    return this->sampleBits;
}

uint32_t waveconfig::get_frame_rate(){
    return this->frameRate;
}

uint16_t waveconfig::get_subformat(){
    return this->subformat;
}

uint16_t waveconfig::get_channel_mask(){
